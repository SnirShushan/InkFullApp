...
List<TermModel> termList = [
  ...
  TermModel(mainTitle: "19. מנויים מתחדשים", description: [
    "19.1. שדרוג לחבילת פרימיום מתבצע כרכישה בתוך האפליקציה דרך App Store או Google Play בלבד. אין תשלום בכרטיס אשראי באפליקציה.",
    "19.2. מנויים בתשלום מתחדשים אוטומטית לפי התקופה והמחיר שמוצגים במסך הרכישה.",
    "19.3. ב-iOS החיוב מחשבון Apple ID באישור הרכישה. המנוי מתחדש אלא אם הביטול יתבצע לפחות 24 שעות לפני סוף התקופה. החיוב הבא מתבצע במהלך 24 השעות שלפני סיום התקופה. ניהול וביטול: הגדרות ← Apple ID ← מנויים.",
    "19.4. אם מוצעת תקופת ניסיון או חודש מתנה, יתרתה שאינה מנוצלת תפקע עם רכישת המנוי.",
  ]),
  TermModel(mainTitle: "18. פנו אלינו", description: [
    "נשתדל לטפל בפניות מתאימות אלינו בהקדם האפשרי. פניות כאמור יש להעביר לפי הפרטים להלן: inkraelco@gmail.com או 050-8821562."
  ])
];

List<TermModel> privacyList = [
  TermModel(mainTitle: "1. כללי", description: [
    "1.1. מדיניות פרטיות זו היא חלק בלתי נפרד מתנאי השימוש לאפליקציה אינק ישראל בבעלות אינק ישראל ח.פ. 434564515.",
    "1.2. מטרתה לפרט אילו נתונים נאספים, לשם מה, ועם מי הם משותפים.",
    "1.3. הנוסח המלא והמעודכן מתפרסם גם בכתובת הציבורית של האפליקציה תחת /privacy.",
  ]),
  TermModel(mainTitle: "2. איזה מידע נאסף", description: [
    "2.1. חשבון: מספר טלפון, שם, דוא״ל אם נמסר, סוג משתמש.",
    "2.2. פרופיל עסקי: שם עסק, כתובת, מיקום בזמן שימוש, סגנונות, תיאור, תמונת פרופיל.",
    "2.3. תוכן: תמונות קעקוע וסקיצות, פניות, דיווחים.",
    "2.4. מכשיר: סוג מכשיר, גרסת אפליקציה, מזהה לצורך התראות.",
    "2.5. רכישות: מזהה מוצר ואסימון רכישה של App Store / Google Play. אין לנו גישה למספר כרטיס אשראי.",
    "2.6. שימוש: אירועי שימוש לשיפור השירות. מעקב פרסומי רק אם אישרת App Tracking Transparency.",
  ]),
  TermModel(mainTitle: "3. שימוש במידע", description: [
    "3.1. יצירת חשבון ואימות ב-SMS.",
    "3.2. הצגת עסקים לפי מיקום וסגנון, וקבלת פניות.",
    "3.3. שמירת תמונות וניהול מגבלות לפי חבילה.",
    "3.4. שחזור מנוי ותמיכה.",
    "3.5. התראות שביקשת לקבל.",
  ]),
  TermModel(mainTitle: "4. צדדים שלישיים", description: [
    "4.1. איננו מוכרים מידע אישי.",
    "4.2. מידע עשוי להיות מעובד אצל Apple, Google, Firebase, ספק האירוח, אחסון מדיה, ספק SMS, ו-Meta רק לפי האישורים שנתת.",
    "4.3. צדדים אלה מחויבים לשמירה דומה על המידע במסגרת השירות שהם מספקים לנו.",
  ]),
  TermModel(mainTitle: "5. הרשאות במכשיר", description: [
    "5.1. מצלמה וגלריה: תמונת פרופיל, פוסטים ופניות קעקוע בלבד.",
    "5.2. מיקום בזמן שימוש בלבד. אין מיקום ברקע.",
    "5.3. מעקב אינו חובה ואינו נדרש כדי להשתמש באפליקציה או לרכוש מנוי.",
  ]),
  TermModel(mainTitle: "6. מחיקה והסכמה", description: [
    "6.1. ניתן למחוק חשבון מתוך האפליקציה.",
    "6.2. ניתן לבטל הרשאות בהגדרות המכשיר או לפנות אלינו.",
  ]),
  TermModel(mainTitle: "7. פנו אלינו", description: [
    "inkraelco@gmail.com · 050-8821562",
  ])
];
