...
class ChangeArtist extends StatefulWidget {
  final String pid;

  const ChangeArtist({Key? key, required this.pid}) : super(key: key);

  @override
  State<ChangeArtist> createState() => _ChangeArtistState();
}

class _ChangeArtistState extends State<ChangeArtist> {
  String selectedId = "";
          ...
          children: [
            ListTile(
                ...
                leading: CachedNetworkImage(
                    imageUrl: WebService.resolveProfileImage(artistListController
