...
import 'model/body_parts.dart';
import 'model/body_side.dart';
import 'service/svg_service.dart';
        ...
        child: CanvasTouchDetector(
          ...
          builder: (context) => CustomPaint(
            painter: _BodyPainter(
              ...
              context: context,
              selectedColor: selectedColor ?? colorScheme.inverseSurface,
              unselectedColor: unselectedColor ?? Colors.white,
              selectedOutlineColor:
                  selectedOutlineColor ?? colorScheme.inversePrimary,
              unselectedOutlineColor:
                  unselectedOutlineColor ?? colorScheme.primary,
            ),
          ),
        ),
      ),
