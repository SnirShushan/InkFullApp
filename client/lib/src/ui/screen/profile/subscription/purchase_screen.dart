...
// NOTE: Documentation-only update. No functional or logic changes have been made.
final bool _kAutoConsume = Platform.isIOS || true;

/// Basic and premium subscription product IDs for in-app purchases.
...
/// List of all product identifiers used for querying in-app purchases.
...
class _PurchaseScreenState extends State<PurchaseScreen> {
  ...
  bool isPremiumPlanBackLoading = false;
  bool isPremiumPurchase = false;
  ...
  bool newBasicFreeDBPurchaseLoading = false;
                                  ...
                                  onTap: () {
                                    if (WebService
                                      ...
                                      if (widget.isEditProfile) {
                                        if ((startupController.subscriptionModel
                                                        .subscriptionStatus
                                                        .toString() ==
                                                    "1" &&
                                                startupController
                                                    ...
                                                    "1") ||
                                            WebService
                                                .isTempPremiumPlanPurchase) {
                                          final BusinessProfileMenuController
          ...
          PurchaseFooterWidget(
            ...
            onRestorePurchase: () async {
              try {
                ...
                setState(() => WebService.isrestoremessageLoading = false);
              }
            },
    ...
    for (final PurchaseDetails purchaseDetails in purchaseDetailsList) {
      if (purchaseDetails.status == PurchaseStatus.pending) {
        ...
        if (purchaseDetails.status == PurchaseStatus.error) {
          ...
          if (mounted) {
            setState(() {
              WebService.isTempPremiumPlanPurchaseLoading = true;
            });
          }
          if (valid) {
  ...
  Container buildBasicPlanContainer(purchases) {
    ...
    try {
      ...
      monthlyPrice = " ₪99.90 לשנה"; // Default price
    }
        ...
        children: [
          ...
          startupController.subscriptionModel.productId ==
              ...
              : AnimationLoaderButtonWidget(
                  ...
                  isLoading: newBasicFreeDBPurchaseLoading,
  ...
  Container buildPremiumPlanContainer(purchases) {
    ...
    try {
      ...
      yearlyPremiumPrice = "₪99.90 לשנה"; // Default price
    }
    ...
    try {
      ...
      monthlyPremiumPrice = " ₪99.90 לשנה"; // Default price
    }
