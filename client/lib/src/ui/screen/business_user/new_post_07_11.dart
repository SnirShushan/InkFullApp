...
//       InkWell(
//         onTap: () async {
//           if (aboutTextController.text.isNotEmpty &&
//               aboutTextController.text.trim().isNotEmpty) {
//             FocusScope.of(context).unfocus();
...
//               begin: Alignment.centerRight, // For RTL, start from right
//               end: Alignment.centerLeft, // For RTL, end at left
//               colors: aboutTextController.text.isNotEmpty
//                   ? [
//                       linearGradieantColor1,
//                       linearGradieantColor2,
//                       linearGradieantColor3,
...
//             "הבא",
//             style: Theme.of(context).textTheme.titleMedium?.copyWith(
//                 color: aboutTextController.text.isEmpty &&
//                         aboutTextController.text.trim().isNotEmpty
//                     ? defaultGrey
//                     : kWhite,
//                 fontWeight: FontWeight.w700),
