...
include __DIR__ . "/class.log_db.php";
...
switch ($action) {
    ...
    case "GetPostDetail":
        ...
        break;
    case "GetPostDetailHTML":
        include "get_post_detail_html.php";
        break;
    case "LikePost":
    ...
    case "FreePlanSubscription":
        include "free_plan_subscribe.php";
        break;
    ...
    case "TestConnection":
        ...
        break;
    case "TestCIConnection":
        include "test_ci_connection.php";
        break;
    case "test1":
        include "test1.php";
        break;
    case "TestIosSub":
        include "test_ios_sub.php";
        break;
    case "CheckNameExists":
        include "is_name_exists.php";
        break;
    case "GetHomePostsNew":
        include "get_home_posts_new.php";
        break;
    default:
...
if ($output_type == 1) {
    ...
    if ($_ENV['enable_app_log'] == "1"){
        try{
            ...
            {
                $lbl_uid.=" (".$_REQUEST['uid'].")";
            }

            if(isset($_REQUEST['app_version']))
            {
                $lbl_uid.=" v".$_REQUEST['app_version'];
            }
            log_activity([
                    'req'=>$_REQUEST,
                    'title'=>"Action : ".$action.$lbl_uid,
                    'data'=>$arr
                ]);
        ...
        // THIS WE ARE NOT USING ANYMORE AS IT TAKES TOO MUCH TIME AND SPACE
