...
class ReportOnPosts extends MY_Controller

{
    ...
    {
        $this->view_data['title'] = $this->settings['hebrew_text']['Report on Post'];

        $this->view_data['menu'] = "Report on Post";

        $this->view_data['back_button'] = base_url();

        $this->view_data['page_heading'] = $this->settings['hebrew_text']['Report on Post'];
