    ...
    <div class="portlet-body form">
        ...
        <div class="table-responsive">
            <table class="table ink-table business_user_list" id="business_user_list">
                <thead>
                    <tr>
                        <th><?= $this->settings['hebrew_text']['Owner']; ?></th>
                        <th><?= $this->settings['hebrew_text']['reported_by_user']; ?></th>
                        <th><?= $this->settings['hebrew_text']['Post']; ?></th>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php 
            $arr_status=array('0'=>'Request Pending','1'=>'Post Blocked','2'=>'Keep Post');
        ?>
        ...
        table = $('#business_user_list').DataTable({
            ...
            ajax: function(data, callback) {
                ...
                $.ajax({
                    url: BASE_URL + "/ajax_ssp/getReortedPostsList",
                    data: data,
                    type: "post",
                    dataType: 'json',
                    beforeSend: function() {},
